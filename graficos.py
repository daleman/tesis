...
if __name__ == "__main__":
    ...
    frames = []
    for p in provincias:
        dfT = pd.read_csv('csv/train_{0}.csv'.format(p),usecols=['tweet_created_at','created_at','user_id','text'],encoding='utf-8',delimiter=',',quotechar='|', quoting=csv.QUOTE_MINIMAL)
