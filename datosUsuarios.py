...
if __name__ == "__main__":
    ...
    for prov in argentina:
        i = 0
        with open('csv/{0}.csv'.format(prov),'w') as fi:
            ...
            file_path = pathTweets + prov + '_tweets.json'
       ...
       # En trainAllCols guardo el conjunto de tweets crudos de train
       # En trainMin guardo solo el conjunto de tweets con el tweetid,user_id,texto 
        with open('csv/train_{0}.csv'.format(prov), 'wb') as trainAllCols, \
            ...
            train_df.to_csv(trainMin,encoding='utf-8', index=False,quotechar='|', quoting=csv.QUOTE_MINIMAL)
        ...
        with open('csv/test_{0}.csv'.format(prov), 'wb') as testAllCols, \
            ...
            test_df.to_csv(testMin,encoding='utf-8', index=False,quotechar='|', quoting=csv.QUOTE_MINIMAL)
