...
\begin{frame}[t]\frametitle{Test t de Welch}
    ...
    \alert<1>{El test de Welch nos provee un valor de probabilidad para rechazar la hipótesis nula que afirma que las medias de las dos distribuciones son iguales.}
    ...
    \only<3>{
       \begin{block}{Metodología}
        ...
        \begin{description}
            \item[Corpus S] Todos los textos (región que cubre > del 80\% de las ocurrencias) 
