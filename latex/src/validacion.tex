...
Calculamos la tasa de rechazo para las palabras en distintos intervalos del listado ordenado según las tres métricas elegidas: la métrica que tiene en cuenta la entropía de palabras, la que valora la entropía de personas, y la que contiene a los dos factores. En la Figura \ref{fig:rechazo_metricas} se muestran los resultados, donde la tasa de rechazo se calcula después de haber aplicado la corrección de Bonferroni para reducir la probabilidad de falsos positivos. La métrica elegida, que tiene a ambos factores en consideración tiene una mejor tasa de rechazo de la hipótesis nula en las palabras consideradas contrastivas y una menor tasa de rechazo para el resto. 
