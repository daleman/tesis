...
\section{Búsqueda geolocalizadas}
...
A continuación se muestra un gráfico con las ubicaciones donde se buscaron los usuarios:
...
Dados los textos, hubo que realizar una limpieza de estos debido a que en \textit{Twitter} ocurren palabras que contienen números dentro de ellas, emoticones y signos de puntuación. Luego se decidió tomar como palabra, aquellas secuencias de caracteres separadas por espacios que no contienen números, signos de puntiación ni emotiones. Esto se realizó con la librería \textit{}
