...
% Describir la eliminacion de outliers por la cota minima de usuarios y de palabras
...
% Contar que con esta medida hicimos una lista
% comentar al principio que queremos un listado con las palabras con contraste
% motivacion de agregar la medida de las personas ademas de las palabras -> para mitigar el ruido 
% creado por bots o personas que hablan siempre de lo mismo (publicidades, etc)

\subsection{Test Hipergeométrico}

%Comentar porque se dividieron los datos, para hacer el test

% Describir que se va a hacer un listado, del que se va a dar un subconjunto a la academia de letras
% al que van a aplicarle una inspeccion manual
% validar con un test hipergeometrico
