...
\hypersetup{
    ...
    pdfkeywords={Tesis, linguistica computacional, linguistica de corpus, lexicografía contrastiva}, % list of keywords
...
\def\tituloTesis{Hacia un método para detectar palabras contrastivas}
