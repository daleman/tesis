...
% Sea $X$ una variable aleatoria discreta con posibles valores $\{x_1, x_2, \dots\, x_n\}$ y una función de probabilidad $P(X)$, luego:
% ${\displaystyle \mathrm {H} (X)=\mathbb{E} [\mathrm {I} (X)]=\mathbb{E} [-\log(\mathrm {P} (X))]} = -\sum\limits_{i=1}^{n} p_i \log(p_{x_i})$
