...
En la Figura \ref{fig:cantPalabrasAnotaciones} graficamos la distribución de la cantidad de ocurrencias de las palabras. Podemos observar que la mayoría de las palabras ocurren poco. En particular el 50\% de las palabras tienen una frecuencia relativa menor a $7.37e-07$. Por otro lado hay pocas palabras que ocurren mucho, por ejemplo la palabra \textit{que} o la preposición \textit{de}. En la Tabla \ref{tab:palabrasMasOcurrentes} del apéndice se encuentran las 20 palabras más frecuentes.
...
\begin{figure}[ht]\centering
    \includegraphics[width=0.88\textwidth]{images/PropAcumSinCandidatas.pdf}
...
\begin{figure}[ht]\centering
    \includegraphics[width=0.88\textwidth]{images/PropAcum5000SinCandidatas.pdf}
